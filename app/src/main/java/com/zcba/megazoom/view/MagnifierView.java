package com.zcba.megazoom.view;
...
public class MagnifierView extends View {
    ...
    public void setScaleZoom(float zoom) {
        scaleX = zoom;
        scaleY = zoom;
    }
...
//            paintShade.setAlpha(magnifierAlpha);
            paintShade.setStyle(Paint.Style.STROKE);
            paintShade.setStrokeWidth(8);
            canvas.drawCircle(magnifierLen / 2, magnifierLen / 2, (magnifierLen - 16) / 2, paintShade);
        }
    }
